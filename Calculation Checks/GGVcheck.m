function [slipAngles, slipRatios, latForces, longForces, wheelLoads, accelerations] = GGVcheck(carData, control_variables, velocity, Ax)
    ...
    slipAngles = [alpha_fl, alpha_fr, alpha_rl,alpha_rr];
    slipRatios = [kappa_fl, kappa_fr, kappa_rl, kappa_rr];
    latForces = [fy_fl, fy_fr, fy_rl, fy_rr];
    longForces = [fx_fl, fx_fr, fx_rl, fx_rr];
    accelerations = [ay_out, ax_out];
    wheelLoads = [w_fl, w_fr, w_rl, w_rr];
