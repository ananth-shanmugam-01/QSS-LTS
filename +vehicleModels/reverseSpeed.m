...
% Slip Angles
alpha_fl = ((V_out*tan(beta) + carData.Chassis.frontMomentArm*yaw_rate) / (V_out + yaw_rate*carData.Chassis.trackWidth*0.5)) - delta;
alpha_fr = ((V_out*tan(beta) + carData.Chassis.frontMomentArm*yaw_rate) / (V_out - yaw_rate*carData.Chassis.trackWidth*0.5)) - delta;
alpha_rl = (V_out*tan(beta) - carData.Chassis.rearMomentArm*yaw_rate) / (V_out + yaw_rate*carData.Chassis.trackWidth*0.5);
alpha_rr = (V_out*tan(beta) - carData.Chassis.rearMomentArm*yaw_rate) / (V_out - yaw_rate*carData.Chassis.trackWidth*0.5);
