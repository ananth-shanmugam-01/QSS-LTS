%% Forward Combined Acceleration Calc

function [ObjectiveFunction,ConstraintFunction] = combinedAccelerationCalc(carData)
    ...
    ax_out = (fx_rl + fx_rr - Fd)/carData.Chassis.mass;
    ...
    c(1) = kappa_fl - 0.15; % Measured Slip Ratio Limits
    c(2) = kappa_fr - 0.15;
    c(3) = kappa_rl - 0.15;
    c(4) = kappa_rr - 0.15;
